...
@section('content')
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('departments.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Add
            Department</a>
    </div>
            ...
            <tbody>
                @foreach ($departments as $department)
                    <tr class="hover:bg-grey-lighter">
                        ...
                        <td class="py-4 px-6 border-b border-grey-light">{{ $department->branch->name ?? 'N/A' }}</td>
