...
@section('content')
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('locations.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Add
            Location</a>
    </div>
            ...
            <tbody>
                @foreach ($locations as $location)
                    <tr class="hover:bg-grey-lighter">
                        ...
                        <td class="py-4 px-6 border-b border-grey-light">{{ $location->branch->name ?? 'N/A' }}</td>
